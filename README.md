...
## Integrantes
* [cite_start][Tu Nombre y Apellido] [cite: 114]
* [cite_start][Nombre y Apellido de tu pareja] [cite: 114]

## Descripción del Proyecto
[cite_start]Este proyecto es un micrositio web desarrollado para la "Feria Tecnológica Universitaria" de la Escuela de Ingeniería[cite: 12, 115]. El sitio busca difundir el evento, mostrar el cronograma de actividades, presentar a los expositores y permitir la inscripción de los estudiantes. Fue construido utilizando HTML5 semántico, CSS3 y Bootstrap 5, aplicando metodologías de diseño responsivo y TDD visual.

## [cite_start]Listado de Páginas [cite: 116]
El sitio consta de 7 páginas interconectadas y coherentes visualmente:
1. `index.html`: Inicio y portada de la feria.
2. `nosotros.html`: Descripción de la feria y la institución.
3. `actividades.html`: Cronograma detallado (CSS Puro).
4. `equipo.html`: Fichas de los expositores (Bootstrap 5).
5. `galeria.html`: Proyectos de innovación destacados.
6. `contacto.html`: Formulario de inscripción.
7. `faq.html`: Preguntas frecuentes y centro de ayuda (Bootstrap 5).

## [cite_start]Componentes Principales de Interfaz Utilizados [cite: 117]
[cite_start]Para mantener una buena experiencia de usuario, se incorporaron los siguientes componentes según su categoría:
...
## Instrucciones de Ejecución con Docker [cite: 118]
